...
import ly.cel.nucleus.exceptions.ConnectivityException;
...
import static ly.cel.nucleus.tasks.state.SyncState.CANCELED_SYNC;
import static ly.cel.nucleus.tasks.state.SyncState.ERROR;
import static ly.cel.nucleus.tasks.state.SyncState.FINISHED_SYNC;
